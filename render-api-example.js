...
app.get("/api/tmdb/search", async (req, res) => {
  try {
    ...
    const url = `https://api.themoviedb.org/3/search/movie?api_key=${encodeURIComponent(TMDB_API_KEY)}&query=${encodeURIComponent(query)}&language=${encodeURIComponent(lang)}&include_adult=false&page=1`;
